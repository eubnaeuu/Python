...
if __name__ == "__main__":
    ...
    api_key = "NCSJUG02JTRZN21R" 
    api_secret = "UWPOZGXUR2LFFWZUX3RSCRCMFKQHWF7M"
    ...
    params['to'] = '01026349926'  # 수신자 번호 입력, 다중으로 보내려면 '01012341234, 01043214321' 으로 입력
    params['from'] = '01026349926'  # 발신자 번호 입력, api_key에 할당된 소유자의 번호로 입력해야 성공적으로 진행됨
    params['text'] = 'coolsms test메시지'  # 보낼 텍스트
